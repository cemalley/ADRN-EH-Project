...
3. Sort BAM files, and do Base Score Recalibration with GATK. gatk-qsub.sh is a wrapper for gatk_streamlined.sh. Note that indel realignment is skipped to minimize compute time. 
