...
y<- paste(x,chrom,"/761MultiVCF/ADRN_chr",chrom,"_vassoc_731_for_maf.out", sep="")
...
b <- paste(x,chrom,"/761MultiVCF/ADRN_chr",chrom,"_731_singleton_list.out",sep="") 
write.table(data6,  file=b, quote=F, sep="\t", row.names=F)
c <- paste(x,chrom,"/761MultiVCF/ADRN_chr",chrom,"_731_001_list.out",sep="")
write.table(data7,  file=c, quote=F, sep="\t", row.names=F)
d <- paste(x,chrom,"/761MultiVCF/ADRN_chr",chrom,"_731_001-005_list.out",sep="")
write.table(data8,  file=d, quote=F, sep="\t", row.names=F)
e <- paste(x,chrom,"/761MultiVCF/ADRN_chr",chrom,"_731_005_list.out",sep="")
