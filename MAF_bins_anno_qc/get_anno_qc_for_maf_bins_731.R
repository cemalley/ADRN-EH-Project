...
var1 <- paste(d,"/ADRN_chr",chrom,"_731_001_list.out", sep="")
var2 <- paste(d,"/ADRN_chr",chrom,"_731_001-005_list.out", sep="")
var3 <- paste(d,"/ADRN_chr",chrom,"_731_005_list.out", sep="")
var4 <- paste(d,"/ADRN_chr",chrom,"_731_singleton_list.out", sep="")
...
out1 <- paste(d,"/ADRN_chr",chrom,"_731_001_list_clean.out", sep="")
out1_sig <- paste(d,"/ADRN_chr",chrom,"_731_001_list_sig_p005_clean.out", sep="")
out1_sig2 <- paste(d,"/ADRN_chr",chrom,"_731_001_list_sig_p0001_clean.out", sep="")
...
out2 <- paste(d,"/ADRN_chr",chrom,"_731_001-005_list_clean.out", sep="")
out2_sig <- paste(d,"/ADRN_chr",chrom,"_731_001-005_list_sig_p005_clean.out", sep="")
out2_sig2 <- paste(d,"/ADRN_chr",chrom,"_731_001-005_list_sig_p0001_clean.out", sep="")
...
out3 <- paste(d,"/ADRN_chr",chrom,"_731_005_list_clean.out", sep="")
out3_sig <- paste(d,"/ADRN_chr",chrom,"_731_005_list_sig_p005_clean.out", sep="")
out3_sig2 <- paste(d,"/ADRN_chr",chrom,"_731_005_list_sig_p0001_clean.out", sep="")
...
out4 <- paste(d,"/ADRN_chr",chrom,"_731_singleton_list_clean.out", sep="")
out4_sig <- paste(d,"/ADRN_chr",chrom,"_731_singleton_list_sig_p005_clean.out", sep="")
out4_sig2 <- paste(d,"/ADRN_chr",chrom,"_731_singleton_list_sig_p0001_clean.out", sep="")
